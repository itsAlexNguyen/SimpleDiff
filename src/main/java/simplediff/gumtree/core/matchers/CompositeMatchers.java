...
import simplediff.gumtree.core.matchers.heuristic.XyBottomUpMatcher;
import simplediff.gumtree.core.matchers.heuristic.cd.ChangeDistillerBottomUpMatcher;
import simplediff.gumtree.core.matchers.heuristic.cd.ChangeDistillerLeavesMatcher;
import simplediff.gumtree.core.matchers.heuristic.cd.ChangeDistillerParallelLeavesMatcher;
import simplediff.gumtree.core.matchers.heuristic.gt.CliqueSubtreeMatcher;
import simplediff.gumtree.core.matchers.heuristic.gt.CompleteBottomUpMatcher;
import simplediff.gumtree.core.matchers.heuristic.gt.GreedyBottomUpMatcher;
import simplediff.gumtree.core.matchers.heuristic.gt.GreedySubtreeMatcher;
import simplediff.gumtree.core.matchers.heuristic.gt.SimpleBottomUpMatcher;
import simplediff.gumtree.core.matchers.optimal.rted.RtedMatcher;
import simplediff.gumtree.core.matchers.optimizations.CrossMoveMatcherThetaF;
import simplediff.gumtree.core.matchers.optimizations.IdenticalSubtreeMatcherThetaA;
import simplediff.gumtree.core.matchers.optimizations.InnerNodesMatcherThetaD;
import simplediff.gumtree.core.matchers.optimizations.LcsOptMatcherThetaB;
import simplediff.gumtree.core.matchers.optimizations.LeafMoveMatcherThetaE;
import simplediff.gumtree.core.matchers.optimizations.UnmappedLeavesMatcherThetaC;
...
public class CompositeMatchers {
  public static class CompositeMatcher implements Matcher {
    ...
    public MappingStore match(ITree src, ITree dst, MappingStore mappings) {
      for (Matcher matcher : matchers) mappings = matcher.match(src, dst, mappings);
