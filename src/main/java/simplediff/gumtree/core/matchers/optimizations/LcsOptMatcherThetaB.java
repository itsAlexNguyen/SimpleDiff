...
package simplediff.gumtree.core.matchers.optimizations;
...
public class LcsOptMatcherThetaB implements Matcher {
  ...
  private static class Implementation {
    ...
    private void backtrack(
        ArrayList<ITree> list1,
        ArrayList<ITree> list2,
        LinkedList<Mapping> resultList,
        int[][] matrix,
        int ipar,
        int jpar,
      ...
      while (ipar > 0 && jpar > 0) {
        if (testCondition(
            list1.get(ipar - 1), list2.get(jpar - 1), unmatchedNodes1, unmatchedNodes2)) {
    ...
    public boolean testCondition(
        ITree node1, ITree node2, Set<ITree> unmatchedNodes1, Set<ITree> unmatchedNodes2) {
