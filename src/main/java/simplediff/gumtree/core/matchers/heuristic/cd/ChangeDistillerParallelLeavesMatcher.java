...
public class ChangeDistillerParallelLeavesMatcher implements Matcher {
  ...
  private static class Implementation {
    ...
    private class ChangeDistillerCallableResult {
      ...
      public ChangeDistillerCallableResult(
          List<Mapping> leafMappings, HashMap<Mapping, Double> simMap) {
    ...
    private class ChangeDistillerLeavesMatcherCallable
      ...
      public ChangeDistillerLeavesMatcherCallable(
          List<ITree> srcLeaves, List<ITree> dstLeaves, int cores, int start) {
