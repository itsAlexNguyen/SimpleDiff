...
public abstract class AbstractTree implements ITree {
  ...
  public String toString() {
    if (hasLabel())
      return String.format("%s: %s [%d,%d]", getType(), getLabel(), getPos(), getEndPos());
    else return String.format("%s [%d,%d]", getType(), getPos(), getEndPos());
  }
  ...
  public void setChildren(List<ITree> children) {
    ...
    for (ITree c : children) c.setParent(this);
  }
