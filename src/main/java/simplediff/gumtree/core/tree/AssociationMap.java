...
public class AssociationMap {
  ...
  /**
   * set metadata `key` with `value` and returns the previous value This method won't remove if
   * value == null
   */
    ...
    return new Iterator<Entry<String, Object>>() {
      ...
      public Entry<String, Object> next() {
        Entry<String, Object> e =
            new AbstractMap.SimpleEntry<>(keys.get(currentPos), values.get(currentPos));
        currentPos++;
        return e;
      }
    };
