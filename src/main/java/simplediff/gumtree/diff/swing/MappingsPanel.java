...
public class MappingsPanel extends JPanel implements TreeSelectionListener {
  ...
  private void openNodes() {
    ...
    panSrc
        .getJTree()
        .scrollPathToVisible(new TreePath(panSrc.getTrees().get(src.getRoot()).getPath()));
    panDst
        .getJTree()
        .scrollPathToVisible(new TreePath(panDst.getTrees().get(dst.getRoot()).getPath()));
  }
  ...
  public void valueChanged(TreeSelectionEvent e) {
    ...
    ITree sel =
        (ITree) ((DefaultMutableTreeNode) jtree.getLastSelectedPathComponent()).getUserObject();
  ...
  private void updateJTreeAndJTextArea(
      ITree sel,
    ...
    selJTextArea
        .getHighlighter()
        .addHighlight(sel.getPos(), sel.getEndPos(), DefaultHighlighter.DefaultPainter);
    ...
    if (isMapped) {
      ...
      matchJTextArea
          .getHighlighter()
          .addHighlight(match.getPos(), match.getEndPos(), DefaultHighlighter.DefaultPainter);
