...
public class DiffView implements Renderable {
  ...
  public DiffView(
      ...
      TreeContext dst,
      Matcher matcher,
      EditScriptGenerator scriptGenerator)
      throws IOException {
    this.fSrc = fSrc;
    this.fDst = fDst;
  ...
  public void renderOn(HtmlCanvas html) throws IOException {
    html.render(DocType.HTML5)
        ...
        .h5()
        .content(fSrc.getName())
        .pre(class_("pre max-height"))
        .content(diffs.getSrcDiff(), false)
        ._div()
        .div(class_("col-lg-6 max-height"))
        .h5()
        .content(fDst.getName())
        .pre(class_("pre max-height"))
        .content(diffs.getDstDiff(), false)
        ._div()
        ._div()
        ._div()
        .render(new BootstrapFooterView())
        .macros()
        .javascript("/dist/diff.js")
        ._body()
        ._html();
  }
      ...
      html.div(class_("col-lg-12"))
          ...
          .a(
              class_("btn btn-default btn-xs")
                  ...
                  .add(
                      "data-content",
                      "<b>q</b> quit<br><b>l</b> list<br><b>n</b> next<br>"
                          + "<b>t</b> top<br><b>b</b> bottom",
                      false)
                  .add("data-original-title", "Shortcuts")
                  .title("Shortcuts")
                  .role("button"))
          .content("Shortcuts")
          ._div()
          .div(class_("btn-group"))
          .a(class_("btn btn-default btn-xs btn-danger").href("/quit"))
          .content("Quit")
          ._div()
          ._div()
          ._div();
